...
import { Compass, Mail, ShieldOff, X } from "lucide-react";
import toast from "react-hot-toast";
import { useMutation, useQueryClient } from "@tanstack/react-query";
import axiosInstance from "../lib/axios";

const SUPPORT_EMAIL = "aschauhan1801@gmail.com";

function AccountBlockedModal({ onClose }) {
  return (
...
export default function LoginPage() {
  ...
  return (
    ...
    >
      ...
      {showBlockedModal ? <AccountBlockedModal onClose={() => setShowBlockedModal(false)} /> : null}
    </div>
  );
}
