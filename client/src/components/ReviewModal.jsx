  ...
  return (
    <div className={OVERLAY_CLASSES} onClick={onCancel}>
      <div className={CARD_CLASSES} onClick={(e) => e.stopPropagation()}>
        ...
        <p className="mt-1.5 text-center text-sm text-base-content/60">Your review helps build trust in the community.</p>
            ...
            >
              <Star
                className={`size-8 transition-colors ${
                  star <= (hoverRating || rating) ? "fill-warning text-warning" : "text-base-content/40"
                }`}
              />
            </button>
          ))}
