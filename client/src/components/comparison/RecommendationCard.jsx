...
export default function RecommendationCard({ property, formatPrice, matchReason }) {
  ...
  return (
    <div 
      className="group bg-base-100 rounded-xl shadow-sm border border-base-300 overflow-hidden hover:shadow-lg hover:border-primary/30 transition-all duration-300 cursor-pointer"
    ...
    >
      <div className="relative aspect-[4/3] overflow-hidden bg-base-200">
        ...
        <div className="absolute top-3 left-3">
          <div className="bg-primary text-white text-xs font-semibold px-3 py-1 rounded-full flex items-center gap-1">
      ...
      <div className="p-4">
        <h3 className="font-semibold text-base-content mb-2 line-clamp-2 text-sm">
          {property.title}
        </h3>
        ...
        <div className="flex items-center gap-3 text-xs text-base-content/70 mb-3">
          {property.bedrooms > 0 && (
