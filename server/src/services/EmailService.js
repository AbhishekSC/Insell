        ...
        <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
          <div style="max-width: 600px; margin: 0 auto; padding: 20px;">
            ...
            <div style="background: #f9f9f9; padding: 30px; border-radius: 0 0 10px 10px;">
              ...
              <p style="margin: 0 0 20px 0;">Thank you for signing up for NearMySpace! To complete your registration and get your verified badge, please use the verification code below:</p>
...
export async function sendWelcomeEmail(email, userName) {
  try {
    const subject = "Welcome to NearMySpace!";
    const html = `
      <!DOCTYPE html>
      <html>
        <head>
          ...
          <div style="max-width: 600px; margin: 0 auto; padding: 20px;">
            ...
            <div style="background: #f9f9f9; padding: 30px; border-radius: 0 0 10px 10px;">
              ...
              <div style="background: white; padding: 20px; border-radius: 8px; margin: 30px 0; border-left: 4px solid #10b981;">
                ...
                <p style="margin: 10px 0 0 0; color: #666;">You can now enjoy all the benefits of being a verified user on NearMySpace.</p>
              </div>
